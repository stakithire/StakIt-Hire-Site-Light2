...
export const protectionAddOns: Service[] = [
  ...
  },
  {
    ...
    description: 'Eco-friendly zip-close sleeve. Available for all sizes.',
    hirePrice: 15,
    purchasePrice: 40,
    unit: 'hire/purchase',
  },
...
export const tvProtectionAddOns: Service[] = [
  {
    ...
    description: 'Padded sleeves for small to medium TVs.',
    hirePrice: 20,
    purchasePrice: 40,
    unit: 'hire/purchase',
  },
  {
    ...
    description: 'Padded sleeves for large TVs.',
    hirePrice: 28,
    purchasePrice: 60,
    unit: 'hire/purchase',
  },
